...
pacman::p_load("tidyverse","rio","here","janitor", "usmap","maps", "colorspace","geofacet","leaidr", "viridis","ggthemes","ggtheme", "arrow", "forcats", "ggrepel","edld652", "mapproj","albersusa" , "cowplot", "biscale", "plotly", "ggeasy", "flexdashboard", "Hmisc", "psych", "dplyr", "stringr", "readr", "tidyr", "corrplot", "scales", "RColorBrewer", "ggmap", "devtools", "piggyback", "maptools", "gitcreds", "knitr", "kableExtra", "xtable", "PerformanceAnalytics", "corrgram", "GGally", "shiny", "gghighlight", "ggtext", "viridis")
```
...
For school year 2017-2018, how was  the student population distributed over different states by race and ethnicity? 
...
map2 <- sm_18 %>%  
        ...
        labs(
            title = "Student Diversity in K-12 Public Schools (2017-18)",
            subtitle = "52% of all students identify as non-White",
            caption = " \n \nGray represents student proportion of less than 1%\nSource: U.S. Department of Education, National Center for Education Statistics, Common Core of Data (CCD)"
        )+
...
For school year 2017-2018, how was the teacher population distributed over different states by race and ethnicity? How does the student and teacher population of color compare? 
...
Is the student population changing over time? What happened during Covid? 
